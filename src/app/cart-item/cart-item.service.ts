...
import { Cart } from '../../database/postgres/entities/cart.entity';
import { CartItem } from '../../database/postgres/entities/cart-item.entity';
...
export class CartItemService {
  ...
  async deleteCartItem(userId: number, cartItem: DeleteCartItemDto) {
    ...
    try {
      ...
      throw new BadRequestException('Error deleting the cart item.');
    }
  }
